...
[![Build Status](https://travis-ci.org/mneudert/instream.svg?branch=v0.12.0)](https://travis-ci.org/mneudert/instream)
[![Coverage Status](https://coveralls.io/repos/mneudert/instream/badge.svg?branch=v0.12.0&service=github)](https://coveralls.io/github/mneudert/instream?branch=v0.12.0)
...
[`.travis.yml`](https://github.com/mneudert/instream/blob/v0.12.0/.travis.yml)
to be sure)
