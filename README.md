...
[![Build Status](https://travis-ci.org/mneudert/instream.svg?branch=v0.11.0)](https://travis-ci.org/mneudert/instream)
[![Coverage Status](https://coveralls.io/repos/mneudert/instream/badge.svg?branch=v0.11.0&service=github)](https://coveralls.io/github/mneudert/instream?branch=v0.11.0)
...
Tested influxdb version: `0.11.0` (see
[`.travis.yml`](https://github.com/mneudert/instream/blob/v0.11.0/.travis.yml)
to be sure)

`InfluxDB v0.12.0` should work as expected when not using now
deprecated/removed methods like the JSON writer. Please use that version at
your own discretion. Be sure to test and remove any broken parts.
